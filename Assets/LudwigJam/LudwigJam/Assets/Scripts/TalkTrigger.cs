...
public class TalkTrigger : MonoBehaviour
{
    ...
    async Task Artist()
    {
        ...
        else if (paper.Pixels.Count() > 150)
        {
            ...
            await Dialogue.Next(textBox, new TextBoxModel(
               text: "I just happen to have this cool thing. You might need it. You can have it!",
               speaker: "Fartist"
           ));
    ...
    async Task SpaceshipPart(TextBox textbox)
    {
        if (Game.GotArtistPart && Game.GotButtonPart && Game.GotCowPart)
        {
            ...
            await Dialogue.End(textbox, new TextBoxModel(
                text: "(It looks like you have everything you need, better return to your spaceship.)"
            ));
        }
        else
        {
